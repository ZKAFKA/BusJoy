  ...
  BlendState._getGLBlendFactor = function _getGLBlendFactor(blendFactor) {
    switch (blendFactor) {
      case exports.BlendFactor.Zero:
        return miniprogramAdapter.WebGLRenderingContext.ZERO;

      case exports.BlendFactor.One:
        return miniprogramAdapter.WebGLRenderingContext.ONE;

      case exports.BlendFactor.SourceColor:
        return miniprogramAdapter.WebGLRenderingContext.SRC_COLOR;

      case exports.BlendFactor.OneMinusSourceColor:
        return miniprogramAdapter.WebGLRenderingContext.ONE_MINUS_SRC_COLOR;

      case exports.BlendFactor.DestinationColor:
        return miniprogramAdapter.WebGLRenderingContext.DST_COLOR;

      case exports.BlendFactor.OneMinusDestinationColor:
        return miniprogramAdapter.WebGLRenderingContext.ONE_MINUS_DST_COLOR;

      case exports.BlendFactor.SourceAlpha:
        return miniprogramAdapter.WebGLRenderingContext.SRC_ALPHA;

      case exports.BlendFactor.OneMinusSourceAlpha:
        return miniprogramAdapter.WebGLRenderingContext.ONE_MINUS_SRC_ALPHA;

      case exports.BlendFactor.DestinationAlpha:
        return miniprogramAdapter.WebGLRenderingContext.DST_ALPHA;

      case exports.BlendFactor.OneMinusDestinationAlpha:
        return miniprogramAdapter.WebGLRenderingContext.ONE_MINUS_DST_ALPHA;

      case exports.BlendFactor.SourceAlphaSaturate:
        return miniprogramAdapter.WebGLRenderingContext.SRC_ALPHA_SATURATE;

      case exports.BlendFactor.BlendColor:
        return miniprogramAdapter.WebGLRenderingContext.CONSTANT_COLOR;

      case exports.BlendFactor.OneMinusBlendColor:
        return miniprogramAdapter.WebGLRenderingContext.ONE_MINUS_CONSTANT_COLOR;
    }
  };

  BlendState._getGLBlendOperation = function _getGLBlendOperation(blendOperation, rhi) {
    var gl = rhi.gl;
  ...
  _proto._platformApply = function _platformApply(rhi, lastState) {
    ...
    if (enabled) {
      ...
      if (colorBlendOperation !== lastTargetBlendState.colorBlendOperation || alphaBlendOperation !== lastTargetBlendState.alphaBlendOperation) {
        gl.blendEquationSeparate(BlendState._getGLBlendOperation(colorBlendOperation, rhi), BlendState._getGLBlendOperation(alphaBlendOperation, rhi));
  ...
  DepthState._getGLCompareFunction = function _getGLCompareFunction(compareFunction) {
    switch (compareFunction) {
      case exports.CompareFunction.Never:
        return miniprogramAdapter.WebGLRenderingContext.NEVER;

      case exports.CompareFunction.Less:
        return miniprogramAdapter.WebGLRenderingContext.LESS;

      case exports.CompareFunction.Equal:
        return miniprogramAdapter.WebGLRenderingContext.EQUAL;

      case exports.CompareFunction.LessEqual:
        return miniprogramAdapter.WebGLRenderingContext.LEQUAL;

      case exports.CompareFunction.Greater:
        return miniprogramAdapter.WebGLRenderingContext.GREATER;

      case exports.CompareFunction.NotEqual:
        return miniprogramAdapter.WebGLRenderingContext.NOTEQUAL;

      case exports.CompareFunction.GreaterEqual:
        return miniprogramAdapter.WebGLRenderingContext.GEQUAL;

      case exports.CompareFunction.Always:
        return miniprogramAdapter.WebGLRenderingContext.ALWAYS;
    }
  }
  ...
  StencilState._getGLStencilOperation = function _getGLStencilOperation(compareFunction) {
    switch (compareFunction) {
      case exports.StencilOperation.Keep:
        return miniprogramAdapter.WebGLRenderingContext.KEEP;

      case exports.StencilOperation.Zero:
        return miniprogramAdapter.WebGLRenderingContext.ZERO;

      case exports.StencilOperation.Replace:
        return miniprogramAdapter.WebGLRenderingContext.REPLACE;

      case exports.StencilOperation.IncrementSaturate:
        return miniprogramAdapter.WebGLRenderingContext.INCR;

      case exports.StencilOperation.DecrementSaturate:
        return miniprogramAdapter.WebGLRenderingContext.DECR;

      case exports.StencilOperation.Invert:
        return miniprogramAdapter.WebGLRenderingContext.INVERT;

      case exports.StencilOperation.IncrementWrap:
        return miniprogramAdapter.WebGLRenderingContext.INCR_WRAP;

      case exports.StencilOperation.DecrementWrap:
        return miniprogramAdapter.WebGLRenderingContext.DECR_WRAP;
    }
  }
  ...
  _proto._platformApply = function _platformApply(rhi, lastState) {
    ...
    if (enabled != lastState.enabled) {
      if (enabled) {
        ...
        gl.disable(miniprogramAdapter.WebGLRenderingContext.STENCIL_TEST);
      }
...
var PrimitiveMesh = /*#__PURE__*/function () {
  ...
  PrimitiveMesh.createCylinder = function createCylinder(engine, radiusTop, radiusBottom, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < torsoVertexCount; ++i) {
      ...
      var radius = radiusBottom - y * (radiusBottom - radiusTop);
...
var Animator = (_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  ...
  _proto._updateCrossFade = function _updateCrossFade(srcPlayData, destPlayData, layerData, weight, delta, additive) {
    ...
    for (var i = crossCurveDataCollection.length - 1; i >= 0; i--) {
      ...
      var srcCurve = srcCurves[srcCurveIndex].curve;
      var destCurve = destCurves[destCurveIndex].curve;
      var srcValue = srcCurveIndex >= 0 ? this._evaluateCurve(property, srcCurve, srcClipTime, additive) : defaultValue;
      var destValue = destCurveIndex >= 0 ? this._evaluateCurve(property, destCurve, destClipTime, additive) : defaultValue;
  ...
  _proto._updateCrossFadeFromPose = function _updateCrossFadeFromPose(destPlayData, layerData, weight, delta, additive) {
    ...
    for (var i = crossCurveDataCollection.length - 1; i >= 0; i--) {
      ...
      var destCurve = curves[destCurveIndex].curve;
      var destValue = destCurveIndex >= 0 ? this._evaluateCurve(curveOwner.property, destCurve, destClipTime, additive) : curveOwner.defaultValue;
...
var AnimationCurve = /*#__PURE__*/function () {
  ...
  _proto._evaluateCubicSpline = function _evaluateCubicSpline(frameIndex, nextFrameIndex, t) {
    var keys = this.keys;
    var squared = t * t;
    var cubed = t * squared;
    ...
    var t1 = keys[frameIndex].value;
    var v1 = keys[frameIndex + 1].value;
    var t2 = keys[frameIndex + 2].value;
    var v2 = keys[nextFrameIndex + 1].value; //CM:clone
