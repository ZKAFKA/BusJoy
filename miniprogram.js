(function (global, factory) {
  ...
  var _my$getSystemInfoSync$1 = my.getSystemInfoSync(),
      ...
      console.log(screenWidth,screenHeight,windowWidth,windowHeight)
      // screenWidth = "300"
      // screenHeight ="300",
      // windowWidth ="300",
      // windowHeight = 400;
  ...
  function style(obj, s1, s2) {
    obj.style = obj.style || {};
    Object.assign(obj.style, {
      top: "0px",
      left: "0px",
      width: innerWidth/10 * s1 + "px",
      height: innerHeight/10 * s2 + "px",
      margin: "0px",
      padding: "0px"
    });
  }
  ...
  function registerCanvas(c, id, s1, s2) {
    canvas = c;
    canvas.id = id;
